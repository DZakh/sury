...
Instead of a lambda, the payload can be a tuple of a transform function and up to 5 arguments to pass after the schema, mirroring the JS `schema.with(fn, ...args)`:
