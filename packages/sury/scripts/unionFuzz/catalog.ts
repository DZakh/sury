...
export const FUZZ_EXPORTS: Record<string, FuzzExport> = {
  ...
  $encodeAsResult: skip(RESCRIPT_BINDING),
  $encodeAsResultPromise: skip(RESCRIPT_BINDING),
  $makeAsResult: skip(RESCRIPT_BINDING),
  $makeAsResultPromise: skip(RESCRIPT_BINDING),
  $parseAsResult: skip(RESCRIPT_BINDING),
  $parseAsResultPromise: skip(RESCRIPT_BINDING),
  ...
  fromJSONSchemaOrThrow: skip("JSON Schema import, not a generation primitive"),
  ...
  assertInputAsPromiseOrReject: skip("operation, not a schema factory"),
  assertInputOrThrow: skip("operation, not a schema factory"),
  assertOutputAsPromiseOrReject: skip("operation, not a schema factory"),
  assertOutputOrThrow: skip("operation, not a schema factory"),
  decodeAsPromiseOrReject: skip("operation, not a schema factory"),
  decodeAsResult: skip("operation, not a schema factory"),
  decodeAsResultPromise: skip("operation, not a schema factory"),
  decodeOrThrow: skip("operation, not a schema factory"),
  encodeAsPromiseOrReject: skip("operation, not a schema factory"),
  encodeAsResult: skip("operation, not a schema factory"),
  encodeAsResultPromise: skip("operation, not a schema factory"),
  ...
  isOutputAsPromise: skip("operation, not a schema factory"),
  makeInputAsPromiseOrReject: skip("operation, not a schema factory"),
  makeInputAsResult: skip("operation, not a schema factory"),
  makeInputAsResultPromise: skip("operation, not a schema factory"),
  makeInputOrThrow: skip("operation, not a schema factory"),
  makeOutputAsPromiseOrReject: skip("operation, not a schema factory"),
  makeOutputAsResult: skip("operation, not a schema factory"),
  makeOutputAsResultPromise: skip("operation, not a schema factory"),
  makeOutputOrThrow: skip("operation, not a schema factory"),
  decodeAsPromisableResult: skip("operation, not a schema factory"),
  encodeAsPromisableResult: skip("operation, not a schema factory"),
  makeInputAsPromisableResult: skip("operation, not a schema factory"),
  makeOutputAsPromisableResult: skip("operation, not a schema factory"),
  parseAsPromisableResult: skip("operation, not a schema factory"),
  parseAsPromiseOrReject: skip("operation, not a schema factory"),
  parseAsResult: skip("operation, not a schema factory"),
  parseAsResultPromise: skip("operation, not a schema factory"),
  ...
  toInputExpression: skip("debug printer, not a schema factory"),
