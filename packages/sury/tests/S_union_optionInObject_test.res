...
test("Union of tagged objects wrapped in S.option as a matches field", t => {
  ...
  t->U.assertCompiledCode(
    ...
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0=(i.foo??null);for(;;){if(typeof v0==="object"&&v0&&!Array.isArray(v0)){for(;;){if(v0.type==="a"){v0=true;break}if(v0.type==="b"){v0=false;break}e[0](v0)};break}if(v0===null){v0=void 0;break}e[1](v0)}return {foo:v0}}catch(v1){e[3](v1)}}`,
  )
