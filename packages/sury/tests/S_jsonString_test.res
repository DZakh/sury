...
test("Parses JSON string to dict", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{typeof i==="string"||e[3](i);let v0;try{v0=JSON.parse(i)}catch(t){e[0](i)}typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);for(let v1 in v0){let v2=v0[v1];typeof v2==="boolean"||e[1](v2,[v1]);}return v0}`,
  )
...
test("Parses JSON string to array", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{typeof i==="string"||e[3](i);let v0;try{v0=JSON.parse(i)}catch(t){e[0](i)}Array.isArray(v0)||e[2](v0);for(let v1=0;v1<v0.length;++v1){let v2=v0[v1];typeof v2==="boolean"||e[1](v2,[v1]);}return v0}`,
  )
...
test("Compiled async parse code snapshot", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#ParseAsync,
    `i=>{try{typeof i==="string"||e[4](i);let v0;try{v0=JSON.parse(i)}catch(t){e[0](i)}typeof v0==="boolean"||e[3](v0);let v1;try{v1=e[1](v0).catch(x=>e[2](x))}catch(x){e[2](x)}return v1}catch(v2){return Promise.reject(v2)}}`,
  )
})
