...
test("Env schema: Reggression version", (t) => {
  ...
  t.expect(S.parser(env(S.boolean)).toString()).toEqual(
    `i=>{if(typeof i==="string"){if(i==="t"){i=true}else if(i==="1"){i=true}else if(i==="f"){i=false}else if(i==="0"){i=false}else if((v0=i==="true",v0||i==="false")){var v0;i=v0}else{e[0](i)}}else{e[1](i)}return i}`,
  );
