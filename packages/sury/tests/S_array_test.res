...
module CommonWithNested = {
  ...
  test("Compiled parse code snapshot", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{Array.isArray(i)||e[1](i);for(let v0=0;v0<i.length;++v0){let v1=i[v0];typeof v1==="string"||e[0](v1,[v0]);}return i}`,
    )
  })
  ...
  test("Compiled async parse code snapshot", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#ParseAsync,
      `i=>{try{Array.isArray(i)||e[2](i);let v2=new Array(i.length);for(let v0=0;v0<i.length;++v0){let v1;try{v1=e[0](i[v0]).catch(x=>e[1](x,[v0]))}catch(x){e[1](x,[v0])}v2[v0]=v1}return Promise.all(v2)}catch(v3){return Promise.reject(v3)}}`,
    )
  })
  ...
  test("Compiled serialize code snapshot with transform", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Encode,
      `i=>{let v2=new Array(i.length);for(let v0=0;v0<i.length;++v0){let v1=i[v0];for(;;){if(typeof v1==="string")break;if(v1===void 0){v1=null;break}e[0](v1,[v0])}v2[v0]=v1}return v2}`,
    )
  })
