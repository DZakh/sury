...
module OuterRecord = {
  ...
  test("Record schema with optional nullable field", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Encode,
      `i=>{let v0=i["record"];if(typeof v0==="object"&&v0&&!Array.isArray(v0)){if(v0["BS_PRIVATE_NESTED_SOME_NONE"]===0){v0=null}else{let v1=v0["k"];if(typeof v1==="object"&&v1&&!Array.isArray(v1)){if(v1["BS_PRIVATE_NESTED_SOME_NONE"]===0){v1=null}else{e[0](v1)}}else if(!(typeof v1==="number"&&!Number.isNaN(v1)&&(v1<=2147483647&&v1>=-2147483648&&v1%1===0)||v1===void 0)){e[1](v1)}v0={"k":v1,}}}else if(!(v0===void 0)){e[2](v0)}return {"record":v0,}}`,
    )
  })
}
