...
test("Reverse converts nullableAsOption string-to-date schema", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{for(;;){if(i instanceof e[0]&&!Number.isNaN(i.getTime())){i=i.toISOString();break}if(i===void 0)break;e[1](i)}return i}`,
  )
})
...
test("Reverse converts nullable string-to-date schema", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{for(;;){if(i instanceof e[0]&&!Number.isNaN(i.getTime())){i=i.toISOString();break}if(i===void 0)break;if(i===null)break;e[1](i)}return i}`,
  )
})
...
test("Encodes a nullable optional Timestamp whose input is string | number (issue repro)", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{for(;;){if(i instanceof e[4]){for(;;){if(!Number.isNaN(i.getTime())){i=i.toISOString();break}let v0;try{v0=e[0](i)}catch(x){e[1](x);e[2](x)}typeof v0==="number"&&v0===v0||e[3](v0);i=v0;break;};break}if(i===void 0)break;e[5](i)}return i}`,
  )
})
