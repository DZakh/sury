...
test("Reverse converts nullableAsOption string-to-date schema", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{for(;;){if(i===void 0)break;if(i===null){i=void 0;break}if(typeof i==="string"){let v0=new Date(i);!Number.isNaN(v0.getTime())||e[0](v0);i=v0;break}e[1](i)}return i}`,
  )
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{for(;;){if(i===void 0)break;if(i instanceof e[0]){i=i.toISOString();break}e[1](i)}return i}`,
  )
})
...
test("Reverse converts nullable string-to-date schema", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{for(;;){if(i===void 0)break;if(i===null)break;if(i instanceof e[0]){i=i.toISOString();break}e[1](i)}return i}`,
  )
})
...
test("Encodes a nullable optional Timestamp whose input is string | number (issue repro)", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{for(;;){if(i===void 0)break;if(i instanceof e[4]){for(;;){i=i.toISOString();break;};break}e[5](i)}return i}`,
  )
})
