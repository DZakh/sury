...
test("Parse reversed schema with nested objects and tuples has type validation", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#ReverseParse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[7](i);let v0=i.foo,v1=i.obj,v4=i.tuple;v0===1||e[0](v0);typeof v1==="object"&&v1&&!Array.isArray(v1)||e[3](v1);let v2=v1.foo,v3=v1.bar;v2===2||e[1](v2);typeof v3==="string"||e[2](v3);Array.isArray(v4)&&v4.length===2||e[6](v4);let v5=v4[0],v6=v4[1];v5===3||e[4](v5);typeof v6==="boolean"||e[5](v6);return {bar:v3,baz:v6}}catch(v7){e[8](v7)}}`,
  )
})
...
module BenchmarkWithSObject = {
  ...
  test("Successfully asserts object from benchmark - with S.object", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Assert,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[10](i);let v0=i.number,v1=i.negNumber,v2=i.maxNumber,v3=i.string,v4=i.longString,v5=i.boolean,v6=i.deeplyNested;typeof v0==="number"||e[0](v0);typeof v1==="number"||e[1](v1);typeof v2==="number"||e[2](v2);typeof v3==="string"||e[3](v3);typeof v4==="string"||e[4](v4);typeof v5==="boolean"||e[5](v5);typeof v6==="object"&&v6&&!Array.isArray(v6)||e[9](v6);let v7=v6.foo,v8=v6.num,v9=v6.bool;typeof v7==="string"||e[6](v7);typeof v8==="number"||e[7](v8);typeof v9==="boolean"||e[8](v9);return void 0}catch(v10){e[11](v10)}}`,
    )
    S.global({})
  })
  ...
  test("Successfully asserts strict object from benchmark - with S.object", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Assert,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[12](i);let v0=i.number,v1=i.negNumber,v2=i.maxNumber,v3=i.string,v4=i.longString,v5=i.boolean,v6=i.deeplyNested,v11;typeof v0==="number"||e[0](v0);typeof v1==="number"||e[1](v1);typeof v2==="number"||e[2](v2);typeof v3==="string"||e[3](v3);typeof v4==="string"||e[4](v4);typeof v5==="boolean"||e[5](v5);typeof v6==="object"&&v6&&!Array.isArray(v6)||e[10](v6);let v7=v6.foo,v8=v6.num,v9=v6.bool,v10;typeof v7==="string"||e[6](v7);typeof v8==="number"||e[7](v8);typeof v9==="boolean"||e[8](v9);for(v10 in v6)if(v10!=="foo"&&v10!=="num"&&v10!=="bool")e[9](v10);for(v11 in i)if(v11!=="number"&&v11!=="negNumber"&&v11!=="maxNumber"&&v11!=="string"&&v11!=="longString"&&v11!=="boolean"&&v11!=="deeplyNested")e[11](v11);return void 0}catch(v12){e[13](v12)}}`,
    )
    S.global({})
  })
...
module Benchmark = {
  ...
  test("Successfully parses strict object from benchmark", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[12](i);let v0=i.number,v1=i.negNumber,v2=i.maxNumber,v3=i.string,v4=i.longString,v5=i.boolean,v6=i.deeplyNested,v11;typeof v0==="number"||e[0](v0);typeof v1==="number"||e[1](v1);typeof v2==="number"||e[2](v2);typeof v3==="string"||e[3](v3);typeof v4==="string"||e[4](v4);typeof v5==="boolean"||e[5](v5);typeof v6==="object"&&v6&&!Array.isArray(v6)||e[10](v6);let v7=v6.foo,v8=v6.num,v9=v6.bool,v10;typeof v7==="string"||e[6](v7);typeof v8==="number"||e[7](v8);typeof v9==="boolean"||e[8](v9);for(v10 in v6)if(v10!=="foo"&&v10!=="num"&&v10!=="bool")e[9](v10);for(v11 in i)if(v11!=="number"&&v11!=="negNumber"&&v11!=="maxNumber"&&v11!=="string"&&v11!=="longString"&&v11!=="boolean"&&v11!=="deeplyNested")e[11](v11);return i}catch(v12){e[13](v12)}}`,
    )
    S.global({})
  })
...
test("Can destructure fields of simple nested objects", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.foo,v2=v0.bar;typeof v1==="string"||e[0](v1);typeof v2==="string"||e[1](v2);return {baz:v2,foz:v1}}catch(v3){e[4](v3)}}`,
  )
...
module Compiled = {
  test("Compiled code snapshot for simple object", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0=i.foo,v1=i.bar;typeof v0==="string"||e[0](v0);typeof v1==="boolean"||e[1](v1);return {foo:v0,bar:v1}}catch(v2){e[3](v2)}}`,
    )
  ...
  test("Compiled code snapshot for refined nested object", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[5](i);let v0=i.foo,v1=i.bar;v0===12||e[0](v0);typeof v1==="object"&&v1&&!Array.isArray(v1)||e[4](v1);let v2=v1.baz;typeof v2==="string"||e[1](v2);let v3={baz:v2};e[2](v3)||e[3](v3);return {foo:v0,bar:v3}}catch(v4){e[6](v4)}}`,
    )
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Encode,
      `i=>{try{let v0=i.bar;e[0](v0)||e[1](v0);return {foo:12,bar:{baz:v0.baz}}}catch(v1){e[2](v1)}}`,
    )
  })
  ...
  test("Compiled parse code snapshot for simple object with async", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#ParseAsync,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v1=i.bar;let v0;try{v0=e[0](i.foo).catch(x=>e[1](x))}catch(x){e[1](x)}typeof v1==="boolean"||e[2](v1);return Promise.all([v0]).then(([v0])=>{return {foo:v0,bar:v1}}).catch(e[4])}catch(v2){return Promise.reject(e[5](v2))}}`,
    )
  })
  ...
  test("Compiled parse code snapshot with async field registered as return", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#ParseAsync,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0;try{v0=e[0](i.foo).catch(x=>e[1](x))}catch(x){e[1](x)}return v0.catch(e[3])}catch(v1){return Promise.reject(e[4](v1))}}`,
    )
  })
  ...
  test("Compiled parse code snapshot for simple object with strict unknown keys", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.foo,v1=i.bar,v2;typeof v0==="string"||e[0](v0);typeof v1==="boolean"||e[1](v1);for(v2 in i)if(v2!=="foo"&&v2!=="bar")e[2](v2);return {foo:v0,bar:v1}}catch(v3){e[4](v3)}}`,
    )
  })
  ...
  test("Compiled code snapshot for nested empty object with strict unknown keys", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v1=i.nested;typeof v1==="object"&&v1&&!Array.isArray(v1)||e[1](v1);let v0;for(v0 in v1)e[0](v0);return {nested:void 0}}catch(v2){e[3](v2)}}`,
    )
  ...
  test(
    ...
    t => {
      ...
      t->U.assertCompiledCode(
        ~schema,
        ~op=#Parse,
        `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i.tag,v1=i.FOO,v2=i.BAR,v3;v0===0||e[0](v0);typeof v1==="string"||e[1](v1);typeof v2==="boolean"||e[2](v2);for(v3 in i)if(v3!=="tag"&&v3!=="FOO"&&v3!=="BAR")e[3](v3);return {foo:v1,bar:v2,zoo:1}}catch(v4){e[5](v4)}}`,
      )
    },
  )
...
test("Compiles to async serialize operation with the sync object schema", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#EncodeAsync,
    `i=>{try{i===void 0||e[0](i);return Promise.resolve({})}catch(v0){return Promise.reject(e[1](v0))}}`,
  )
})
...
test("Reverse object with discriminant which is an object transformed to literal", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.kind,v2=i.field;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[1](v0);let v1=v0.nestedKind;v1==="test"||e[0](v1);typeof v2==="boolean"||e[2](v2);return v2}catch(v3){e[4](v3)}}`,
  )
