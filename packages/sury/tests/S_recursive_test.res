...
asyncTest("Successfully parses recursive object using S.parseAsPromiseOrReject", t => {
  ...
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#ParseAsync,
    `i=>{try{let v0;v0=e[0](i);return Promise.resolve(v0)}catch(v1){return Promise.reject(e[1](v1))}}
...
asyncTest("Successfully parses recursive object with async parse function", t => {
  ...
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#ParseAsync,
    `i=>{try{let v0;v0=e[0](i);return v0.catch(e[1])}catch(v1){return Promise.reject(e[2](v1))}}
