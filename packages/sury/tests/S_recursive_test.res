...
asyncTest("Successfully parses recursive object using S.parseAsPromiseOrReject", t => {
  ...
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#ParseAsync,
    `i=>{try{try{let v0;v0=e[0](i);return Promise.resolve(v0)}catch(v1){e[1](v1)}}catch(v2){return Promise.reject(v2)}}
Node: i=>{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.Id,v1=i.Children;typeof v0==="string"||e[0](v0);Array.isArray(v1)||e[2](v1);let v5=new Array(v1.length);for(let v2=0;v2<v1.length;++v2){let v3;try{v3=e[1].v(v1[v2]);}catch(v4){v4.path=["Children",v2,...v4.path];throw v4}v5[v2]=v3}return {id:v0,children:v5}}`,
  )
...
Node: i=>{let v0=i.children;let v4=new Array(v0.length);for(let v1=0;v1<v0.length;++v1){let v2;try{v2=e[0].v(v0[v1]);}catch(v3){v3.path=["children",v1,...v3.path];throw v3}v4[v1]=v2}return {Id:i.id,Children:v4}}`,
  )
...
test("Parses multiple nested recursive object inside of another object", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0;try{v0=e[0](i.recursive1);}catch(v1){v1.path=["recursive1",...v1.path];throw v1}let v2;try{v2=e[1](i.recursive2);}catch(v3){v3.path=["recursive2",...v3.path];throw v3}return {recursive1:v0,recursive2:v2}}catch(v4){e[3](v4)}}`,
  )
...
test("Shallowly transforms object when added transform to the S.recursive result", t => {
  ...
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#Parse,
    `i=>{try{let v0;v0=e[0](i);let v1;try{v1=e[1](v0)}catch(x){e[2](x)}return v1}catch(v2){e[3](v2)}}
Node: i=>{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.Id,v1=i.Children;typeof v0==="string"||e[0](v0);Array.isArray(v1)||e[2](v1);let v5=new Array(v1.length);for(let v2=0;v2<v1.length;++v2){let v3;try{v3=e[1].v(v1[v2]);}catch(v4){v4.path=["Children",v2,...v4.path];throw v4}v5[v2]=v3}return {id:v0,children:v5}}`,
  )
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#Encode,
    ~embedded=[("Node", 2)],
    `i=>{try{let v0;try{v0=e[0](i)}catch(x){e[1](x)}let v1;v1=e[2](v0);return v1}catch(v2){e[3](v2)}}
Node: i=>{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.id,v1=i.children;typeof v0==="string"||e[0](v0);Array.isArray(v1)||e[2](v1);let v5=new Array(v1.length);for(let v2=0;v2<v1.length;++v2){let v3;try{v3=e[1].v(v1[v2]);}catch(v4){v4.path=["children",v2,...v4.path];throw v4}v5[v2]=v3}return {Id:v0,Children:v5}}`,
  )
})
