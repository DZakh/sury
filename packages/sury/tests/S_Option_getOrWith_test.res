...
test("Compiled async parse code snapshot", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#ParseAsync,
    `i=>{if(typeof i==="boolean"){let v0;try{v0=e[0](i).catch(x=>e[1](x))}catch(x){e[1](x)}i=v0}else if(!(i===void 0)){e[2](i)}let v1=Promise.resolve(i);return v1.then(v1=>{return v1===void 0?e[3]():v1})}`,
  )
})
