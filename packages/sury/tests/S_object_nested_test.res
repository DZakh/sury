...
test("Object with a single nested field", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[1](v0);let v1=v0.foo;typeof v1==="string"||e[0](v1);return v1}catch(v2){e[3](v2)}}`,
  )
...
test("Object with a single nested field with S.transform", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[3](v0);let v2=v0.foo;typeof v2==="number"&&v2==v2||e[2](v2);let v1;try{v1=e[0](v2)}catch(x){e[1](x)}return v1}catch(v3){e[5](v3)}}`,
  )
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{try{let v0;try{v0=e[0](i)}catch(x){e[1](x)}typeof v0==="number"&&v0==v0||e[2](v0);return {nested:{foo:v0}}}catch(v1){e[3](v1)}}`,
  )
  t->Assert.deepEqual(
...
test("Object with a nested tag and optional field", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i.nested,v3=i.bar;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.tag,v2=v0.foo;v1==="value"||e[0](v1);if(v2===void 0){v2=""}else{typeof v2==="string"||e[1](v2);}typeof v3==="string"||e[3](v3);return {foo:v2,bar:v3}}catch(v4){e[5](v4)}}`,
  )
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
...
test("Object with a two nested field using the same ctx", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.foo,v2=v0.bar;typeof v1==="string"||e[0](v1);typeof v2==="string"||e[1](v2);return {foo:v1,bar:v2}}catch(v3){e[4](v3)}}`,
  )
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
...
test("Object with a single nested nested field", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.deeply;typeof v1==="object"&&v1&&!Array.isArray(v1)||e[1](v1);let v2=v1.foo;typeof v2==="string"||e[0](v2);return v2}catch(v3){e[4](v3)}}`,
  )
...
test("Object with a flattened nested field", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[1](v0);let v1=v0.foo;typeof v1==="string"||e[0](v1);return {foo:v1}}catch(v2){e[3](v2)}}`,
  )
...
test("S.schema object with a deep strict applied to the nested field parent", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i.nested,v3;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.foo,v2;typeof v1==="string"||e[0](v1);for(v2 in v0)if(v2!=="foo")e[1](v2);for(v3 in i)if(v3!=="nested")e[3](v3);return i}catch(v4){e[5](v4)}}`,
  )
...
test("Nested preprocessed tags on reverse convert", t => {
  ...
  t->U.assertCompiledCode(
    ~op=#Encode,
    ~schema,
    `i=>{try{i===void 0||e[6](i);let v0;try{v0=e[0]("value")}catch(x){e[1](x)}typeof v0==="string"||e[2](v0);let v1;try{v1=e[3]("1")}catch(x){e[4](x)}typeof v1==="string"||e[5](v1);return {nested:{tag:v0,intTag:v1}}}catch(v2){e[7](v2)}}`,
  )

  t->U.assertCompiledCode(
    ~op=#Parse,
    ~schema,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[11](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[10](v0);let v2=v0.tag,v4=v0.intTag;typeof v2==="string"||e[4](v2);let v1;try{v1=e[0](v2)}catch(x){e[1](x)}typeof v1==="string"||e[3](v1);v1==="value"||e[2](v1);typeof v4==="string"||e[9](v4);let v3;try{v3=e[5](v4)}catch(x){e[6](x)}typeof v3==="string"||e[8](v3);v3==="1"||e[7](v3);return void 0}catch(v5){e[12](v5)}}`,
  )
...
test("Object with a deep strict applied to the nested field parent", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i.nested,v3;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.foo,v2;typeof v1==="string"||e[0](v1);for(v2 in v0)if(v2!=="foo")e[1](v2);for(v3 in i)if(v3!=="nested")e[3](v3);return v1}catch(v4){e[5](v4)}}`,
  )
  t->U.assertCompiledCode(~schema, ~op=#Encode, `i=>{return {nested:{foo:i}}}`)
})
...
test("Object with a deep strict applied to the nested field parent + reverse", t => {
  ...
  t->U.assertCompiledCode(
    ...
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[2](i);let v0=i.foo,v1;typeof v0==="string"||e[0](v0);for(v1 in i)if(v1!=="foo")e[1](v1);return {nested:{foo:v0}}}catch(v2){e[3](v2)}}`,
  )
...
test("Object with nested field together with flatten", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[3](i);let v0=i.nested;typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0.foo,v2=v0.bar;typeof v1==="string"||e[0](v1);typeof v2==="string"||e[1](v2);return {flattened:{foo:v1},field:v2}}catch(v3){e[4](v3)}}`,
  )
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
