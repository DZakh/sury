...
Ava("Compiled parse code snapshot", (function (t) {
        var schema = S.literal(null);
        U.assertCompiledCode(t, schema, "Parse", "i=>{if(i!==null){e[0](i)}return i}", undefined);
      }));

Ava("Compiled serialize code snapshot", (function (t) {
        var schema = S.literal(null);
        U.assertCompiledCode(t, schema, "ReverseConvert", "i=>{if(i!==null){e[0](i)}return i}", undefined);
      }));
...
Ava("Succesfully uses reversed schema for parsing back to initial value", (function (t) {
        var schema = S.literal(null);
        U.assertReverseParsesBack(t, schema, null);
      }));
