...
test("Array stays disjoint from object even if it's later in the union", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{try{for(;;){if(typeof i==="object"&&i&&!Array.isArray(i)){let v0=i.foo;typeof v0==="string"||e[0](v0);i=[v0];break}if(Array.isArray(i)){for(let v1=0;v1<i.length;++v1){try{let v2=i[v1];typeof v2==="string"||e[1](v2);}catch(v3){v3.path=[v1,...v3.path];throw v3}};break}e[2](i)}return i}catch(v4){e[3](v4)}}`,
  )
})
