...
- Expected url, received "123"`,
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{if(typeof i==="string"){for(;;){let r;try{e[0].test(i)||e[1](i);break}catch(x){(r||(r=[])).push(e[4](x));}try{e[2](i)||e[3](i);break}catch(x){(r||(r=[])).push(e[4](x));e[5](i,...(r||[]))}e[6](i,...(r||[]))}}else{e[7](i)}return i}`,
  )
})
...
- At ["value"]: Expected string, received 1`,
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{for(;;){let r;if(typeof i==="object"&&i&&!Array.isArray(i)&&i["type"]==="A"){try{let v0=i["value"];typeof v0==="string"&&(v0==="foo"||v0==="bar")||e[0](v0);i={"TAG":"Ok","_0":v0,};break}catch(x){(r||(r=[])).push(e[2](x));}try{let v1=i["value"];typeof v1==="string"||e[1](v1);i={"TAG":"Error","_0":v1,};break}catch(x){(r||(r=[])).push(e[2](x));e[3](i,...(r||[]))}}e[4](i,...(r||[]))}return i}`,
  )
})
