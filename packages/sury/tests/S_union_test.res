...
test("Union with nested variant", t => {
  ...
  t->U.assertCompiledCode(
    ...
    `i=>{for(;;){let r;if(typeof i==="object"&&i&&!Array.isArray(i)){try{let v0=i["foo"];typeof v0==="object"&&v0&&!Array.isArray(v0)||e[2](v0);let v1=v0["tag"];typeof v1==="object"&&v1&&!Array.isArray(v1)&&v1["NAME"]==="Null"||e[1](v1);let v2=v1["VAL"];for(;;){if(v2===void 0){v2=null;break}if(typeof v2==="string")break;e[0](v2)}i={foo:{tag:{NAME:v1["NAME"],VAL:v2}}};break}catch(x){(r||(r=[])).push(e[6](x))}try{let v3=i["foo"];typeof v3==="object"&&v3&&!Array.isArray(v3)||e[5](v3);let v4=v3["tag"];typeof v4==="object"&&v4&&!Array.isArray(v4)&&v4["NAME"]==="Option"||e[4](v4);let v5=v4["VAL"];(v5===void 0||typeof v5==="string")||e[3](v5);i={foo:{tag:{NAME:v4["NAME"],VAL:v5}}};break}catch(x){(r||(r=[])).push(e[6](x))}}e[7](i,...(r||[]))}return i}`,
  )
})
...
test("Reverse schema with items", t => {
  ...
  t->U.assertEqualSchemas(
    schema->S.reverse,
    S.union([S.literal(%raw(`0`)), S.nullAsUnit->S.reverse, S.bool->S.castToUnknown]),
  )
})
...
module CknittelBugReport = {
  ...
  test("Union serializing of objects with optional fields", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{for(;;){let r;if(typeof i==="object"&&i&&!Array.isArray(i)){try{let v0=i["payload"];typeof v0==="object"&&v0&&!Array.isArray(v0)||e[1](v0);let v1=v0["a"];(v1===void 0||typeof v1==="string")||e[0](v1);i={TAG:"A",_0:{payload:{a:v1}}};break}catch(x){(r||(r=[])).push(e[4](x))}try{let v2=i["payload"];typeof v2==="object"&&v2&&!Array.isArray(v2)||e[3](v2);let v3=v2["b"];(v3===void 0||typeof v3==="number"&&v3===v3&&v3<=2147483647&&v3>=-2147483648&&v3%1===0)||e[2](v3);i={TAG:"B",_0:{payload:{b:v3}}};break}catch(x){(r||(r=[])).push(e[4](x))}}e[5](i,...(r||[]))}return i}`,
    )
...
test("Optional of int32 should keep a format validation", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{(i===void 0||typeof i==="number"&&i===i&&i<=2147483647&&i>=-2147483648&&i%1===0)||e[0](i);return i}`,
  )
})
