...
test("Example", t => {
  ...
  t->U.assertCompiledCode(
    ~schema=filmSchema,
    ~op=#EncodeToJson,
    `i=>{try{let v0=i.tags,v6=i.deprecatedAgeRestriction;Array.isArray(v0)||e[1](v0);for(let v2=0;v2<v0.length;++v2){try{let v3=v0[v2];typeof v3==="string"||e[0](v3);}catch(v4){v4.path=["tags",v2,...v4.path];throw v4}}let v5={Id:i.id,Title:i.title,Tags:v0,Rating:i.rating};if(v6!==void 0){v5.Age=v6}return v5}catch(v7){e[2](v7)}}`,
  )
})
...
test("Compiled serialize code snapshot", t => {
  t->U.assertCompiledCode(
    ~schema=filmSchema,
    ~op=#Encode,
    `i=>{try{let v0=i.tags;Array.isArray(v0)||e[1](v0);for(let v2=0;v2<v0.length;++v2){try{let v3=v0[v2];typeof v3==="string"||e[0](v3);}catch(v4){v4.path=["tags",v2,...v4.path];throw v4}}return {Id:i.id,Title:i.title,Tags:v0,Rating:i.rating,Age:i.deprecatedAgeRestriction}}catch(v5){e[2](v5)}}`,
  )
})
