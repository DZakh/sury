...
test("Compiled parse code snapshot", t => {
  t->U.assertCompiledCode(
    ~schema=filmSchema,
    ~op=#Parse,
    `i=>{typeof i==="object"&&i&&!Array.isArray(i)||e[7](i);let v0=i["Id"],v1=i["Title"],v2=i["Tags"],v6=i["Rating"],v7=i["Age"];typeof v0==="number"&&v0===v0||e[0](v0);typeof v1==="string"||e[1](v1);if(v2===void 0){v2=e[2]}else{Array.isArray(v2)||e[4](v2);for(let v3=0;v3<v2.length;++v3){try{let v4=v2[v3];typeof v4==="string"||e[3](v4);}catch(v5){v5.path="[\\"Tags\\"]"+\'["\'+v3+\'"]\'+v5.path;throw v5}}}typeof v6==="string"&&(v6==="G"||v6==="PG"||v6==="PG13"||v6==="R")||e[5](v6);(v7===void 0||typeof v7==="number"&&v7===v7&&v7<=2147483647&&v7>=-2147483648&&v7%1===0)||e[6](v7);return {id:v0,title:v1,tags:v2,rating:v6,deprecatedAgeRestriction:v7}}`,
  )
})
