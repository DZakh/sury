...
module Common = {
  ...
  test("Compiled async parse code snapshot", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#ParseAsync,
      `i=>{try{let v0;try{v0=e[0](i).catch(x=>e[1](x))}catch(x){e[1](x)}i=v0}catch(e0){e[2](e0);if(!(i===void 0)){e[3](i,e0)}}return Promise.resolve(i)}`,
    )
  })
...
test("Serializes Some(None) to undefined for option nested in null", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{if(i===void 0){i=null}else if(typeof i==="object"&&i&&!Array.isArray(i)&&i["BS_PRIVATE_NESTED_SOME_NONE"]===0){i=void 0}else if(!(typeof i==="boolean")){e[0](i)}return i}`,
  )
})
...
test("Applies valFromOption for Some()", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{if(typeof i==="object"&&i&&!Array.isArray(i)&&i["BS_PRIVATE_NESTED_SOME_NONE"]===0){i=void 0}else if(!(i===void 0)){e[0](i)}return i}`,
  )
})
...
test("Nested option support", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Encode,
    `i=>{if(typeof i==="object"&&i&&!Array.isArray(i)&&i["BS_PRIVATE_NESTED_SOME_NONE"]===0){i=void 0}else if(!(typeof i==="boolean"||i===void 0)){e[0](i)}return i}`,
  )
})
...
test(
  ...
  t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Encode,
      `i=>{if(typeof i==="object"&&i&&!Array.isArray(i)&&i["BS_PRIVATE_NESTED_SOME_NONE"]===0){i={}}else if(!(i===void 0)){e[0](i)}return i}`,
    )
  },
)
