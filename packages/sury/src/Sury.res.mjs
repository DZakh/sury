  ...
  while(true) {
    ...
    if (parser !== undefined) {
      ...
      if (isFromLiteral && isTargetLiteral) {
        coercion = (function(target){
        return function (b, param, param$1) {
          return {
                  b: b,
                  v: _notVar,
        ...
        switch (fromTag) {
          case "string" :
              ...
              if (exit$2 === 3) {
                ...
                if (isTargetLiteral) {
                  coercion = (function(target,$$const){
                  ...
                  switch (match) {
                    case "number" :
                        ...
                        coercion = (function(target,format){
                        return function (b, inputVar, failCoercion) {
                          var output = {
                            b: b,
                            v: _notVar,
