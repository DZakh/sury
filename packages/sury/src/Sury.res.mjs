...
function withCoerceScope(b, input, path, target, coercion) {
  ...
  var output = coercion(bb, inputVar, failWithArg(bb, path, (function (input) {
              return {
                      TAG: "InvalidType",
                      expected: target,
                      received: input
...
function parse(b, _schema, _input, path) {
  while(true) {
    var input = _input;
    var schema = _schema;
        ...
        switch (fromTag) {
          case "string" :
              ...
              if (exit$2 === 3) {
                ...
                if (isTargetLiteral) {
                  input$3 = withCoerceScope(b, input$1, path, target, (function(target,$$const){
                      return function (b, inputVar, failCoercion) {
                  ...
                  switch (match) {
                    case "number" :
                        ...
                        input$3 = withCoerceScope(b, input$1, path, target, (function(target,format){
                            return function (b, inputVar, failCoercion) {
                              var output = {
                                b: b,
                                v: _notVar,
                        ...
                        break;
                    case "bigint" :
                        input$3 = withCoerceScope(b, input$1, path, target, (function (b, inputVar, failCoercion) {
...
function parseWithTypeValidation(b, schema, input, path) {
  typeValidation(b, schema, input, path);
  ...
  return updateOutput(schema, (function (mut) {
                ...
                if (items !== undefined) {
                  ...
                  if ($$default.TAG === "Value") {
                    defaultValue = $$default._0;
                  } else {
                    throw new Error("[Sury] FIXME: Default callbacks are not supported yet.");
                  }
...
function definitionToRitem(definition, path, ritems, ritemsByItemPath) {
  ...
  if (Array.isArray(definition)) {
    ...
    return {
            k: 2,
            p: path,
            s: (mut.type = "array", mut.items = items, mut.additionalItems = "strict", mut.parser = parser, mut.output = output, mut),
            a: true
          };
  }
  ...
  return {
          k: 2,
          p: path,
          s: (mut$1.type = "object", mut$1.items = items$1, mut$1.fields = fields, mut$1.additionalItems = globalConfig.a, mut$1.advanced = true, mut$1.parser = parser, mut$1.output = output, mut$1),
          a: false
        };
}
    ...
    mut.parser = (function (b, input, selfSchema, path) {
        ...
        var getItemOutput = function (item, itemPath) {
          ...
          if (ritem !== undefined) {
            ...
            return parse(b, reversed, itemInput, path$1);
          }
          var reversed$1 = reverse(item.schema);
          var input = reversedToInput(reversed$1, itemPath);
          var prevFlag = b.g.o;
          b.g.o = (prevFlag | 1) ^ 1;
          var output = parse(b, reversed$1, input, path);
          b.g.o = prevFlag;
          return output;
        };
        if (to !== undefined) {
  ...
  if (jsonSchema.nullable) {
    ...
    if (type_$1 === "object") {
      ...
      if (properties !== undefined) {
        var schema$5 = object(function (s) {
              var obj = {};
        ...
        schema$4 = additionalProperties !== undefined && Caml_option.valFromOption(additionalProperties) === false ? strict(schema$5) : schema$5;
      } else {
        ...
        if (additionalProperties$1 !== undefined) {
          ...
          schema$4 = factory$5(function (param) {
      ...
      if (items !== undefined) {
        ...
        if (single.TAG === "Single") {
          schema$6 = factory$2(definitionToSchema(single._0));
        } else {
          var array = single._0;
          schema$6 = tuple(function (s) {
        ...
        if (not !== undefined) {
          ...
          if ($$const !== undefined) {
            ...
            if (Array.isArray(type_$2)) {
              schema$4 = factory(type_$2.map(function (type_) {
              ...
              var schema$8 = p$1 !== undefined ? pattern(schema, new RegExp(p$1), undefined) : schema;
              var minLength = jsonSchema.minLength;
              var schema$9 = minLength !== undefined ? stringMinLength(schema$8, minLength, undefined) : schema$8;
              var maxLength = jsonSchema.maxLength;
              var schema$10 = maxLength !== undefined ? stringMaxLength(schema$9, maxLength, undefined) : schema$9;
