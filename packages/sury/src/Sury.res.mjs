  ...
  return input => {
    ...
    if (em !== undefined) {
      ...
      if (m !== undefined) {
        ...
        let m$1 = em["_"];
        message = m$1 !== undefined ? m$1 : defaultMessage;
      }
    } else {
...
function failInvalidTypeWithErrorMessage(key) {
  return input => {
    let em = input.e.errorMessage;
    let override;
    if (em !== undefined) {
...
function enablePort() {
  if (port[shakenRef]) {
    ...
    port.refiner = param => [{
        ...
        f: failInvalidTypeWithErrorMessage("format")
      }];
    return;
  }
...
function enableEmail() {
  ...
  email.refiner = input => [{
      ...
      f: failWithErrorMessage("format", "Invalid email address")
    }];
}
...
function enableUuid() {
  ...
  uuid.refiner = input => [{
      ...
      f: failWithErrorMessage("format", "Invalid UUID")
    }];
}
...
function enableCuid() {
  ...
  cuid.refiner = input => [{
      ...
      f: failWithErrorMessage("format", "Invalid CUID")
    }];
}
...
function enableUrl() {
  ...
  url.refiner = input => [{
      ...
      f: failWithErrorMessage("format", "Invalid url")
    }];
}
