...
function arrayDecoder(unknownInput) {
  ...
  if (itemSchema === "strip" || itemSchema === "strict") {
    ...
    let v = asyncVal(output, "Promise.all(" + output.i + ")");
    v.v();
    return v;
  }
...
function objectDecoder(unknownInput) {
  ...
  if (itemSchema === "strip" || itemSchema === "strict") {
    ...
    let v = asyncVal(output, "new Promise((" + resolveVar + "," + rejectVar + ")=>{let " + counterVar + "=Object.keys(" + outputVar + ").length;for(let " + keyVar + " in " + outputVar + "){" + outputVar + "[" + keyVar + "].then(" + asyncParseResultVar + "=>{" + outputVar + "[" + keyVar + "]=" + asyncParseResultVar + ";if(" + counterVar + "--===1){" + resolveVar + "(" + outputVar + ")}}," + rejectVar + ")}})");
    v.v();
    return v;
  }
  if (exit === 1) {
