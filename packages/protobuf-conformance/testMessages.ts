...
export const testAllTypesProto3: S.Schema<unknown, unknown> = S.recursive(
  "TestAllTypesProto3",
  (self) => {
    const nestedMessage = S.recursive("NestedMessage", () =>
      S.schema({ a: i32(1), corecursive: S.optional(self).with(S.protobufField, 2) }),
    );
    return S.schema({
