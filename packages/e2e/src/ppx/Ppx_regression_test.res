...
module CknittelBugReport2 = {
  ...
  test("Successfully parses nested optional union", t => {
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i.test;for(;;){if(typeof v0==="object"&&v0&&!Array.isArray(v0)){for(;;){if(v0.type==="a"){let v1=v0.x;typeof v1==="number"&&v1<=2147483647&&v1>=-2147483648&&v1%1==0||e[0](v1);v0={TAG:"A",_0:{x:v1}};break}if(v0.type==="b"){let v2=v0.y;typeof v2==="string"||e[1](v2);v0={TAG:"B",_0:{y:v2}};break}e[2](v0)};break}if(v0===void 0)break;e[3](v0)}return {test:v0}}catch(v3){e[5](v3)}}`,
    )
  ...
  test("Nested literal field with catch", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{try{for(;;){let r;if(typeof i==="object"&&i&&!Array.isArray(i)){try{let v0=i.statusCode;typeof v0==="object"&&v0&&!Array.isArray(v0)&&v0.kind==="ok"||e[0](v0);i={TAG:"Ok",_0:void 0};break}catch(x){(r||(r=[])).push(e[4](x))}try{let v1=i.statusCode;typeof v1==="object"&&v1&&!Array.isArray(v1)&&v1.kind==="serviceError"||e[3](v1);let v2=v1.serviceCode,v3=v1.text;typeof v2==="string"||e[1](v2);typeof v3==="string"||e[2](v3);i={TAG:"Error",_0:{serviceCode:v2,text:v3}};break}catch(x){(r||(r=[])).push(e[4](x))}}e[5](i,...(r||[]))}return i}catch(v4){e[6](v4)}}`,
    )
