...
module CknittelBugReport2 = {
  ...
  test("Successfully parses nested optional union", t => {
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{typeof i==="object"&&i&&!Array.isArray(i)||e[4](i);let v0=i["test"];for(;;){if(v0===void 0)break;if(typeof v0==="object"&&v0&&!Array.isArray(v0)){for(;;){if(v0["type"]==="a"){let v1=v0["x"];typeof v1==="number"&&v1<=2147483647&&v1>=-2147483648&&v1%1===0||e[0](v1);v0={TAG:"A",_0:{x:v1}};break;}if(v0["type"]==="b"){let v2=v0["y"];typeof v2==="string"||e[1](v2);v0={TAG:"B",_0:{y:v2}};break;}e[2](v0)};break;}e[3](v0)}return {test:v0}}`,
    )
